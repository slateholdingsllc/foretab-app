...
export default function AuthLayout({
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-4 py-10 sm:px-6">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-32 -top-32 h-[420px] w-[420px] rounded-full bg-accent opacity-[0.10] blur-[20px]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-28 -left-24 h-[260px] w-[260px] rounded-full bg-amber opacity-[0.14] blur-[12px]"
      />
      ...
      <div className="relative z-10 w-full max-w-[clamp(360px,42vw,460px)]">
        {children}
      </div>
    </main>
  );
